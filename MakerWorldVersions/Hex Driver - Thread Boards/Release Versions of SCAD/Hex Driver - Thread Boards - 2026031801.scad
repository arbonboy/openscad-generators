...
/* [Hidden] */
Metric_Hex_Size = "None"; //["2","2.5","3","3.5","4","4.5","6","8","10","12","14","17","19"]
                    ...
                    translate([0, hexSize/2-hexSize/10, Hex_Length/2]){ // Position the label above the driver
                        rotate([90, 90, 180]){
                            linear_extrude(height=202){
                                text(hexLabel, size=hexSize/2, halign="center", valign="center", font="Liberation Mono:style=Bold");
                            }
                        } 
                    }
                }
