...
/* [General Parameters] */
Metric_Hex_Size = "14"; //["2.5","3","3.5","4","4.5","6","8","10","12","14","17","19"]
Hex_Length = 120; //[80:1:300]
Handle_Type = "tstyle"; //[none:None,arm:Single Arm,tstyle:T-Style]
Handle_Size = 50; //[5:X-Small,20:Small,50:Medium,75:Large]
Handle_Radius = 1; //[2:Small, 1.5:Medium, 1:Large, 0.6:X-Large]


/* [Hidden] */
Thread_Board_Hex_Size = "None"; //[Normal,Mounting Hole]
