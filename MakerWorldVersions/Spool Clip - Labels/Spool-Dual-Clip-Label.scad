...
Inner_Spool_Width = 59;      //[20:0.1:70]
//Thickness of spool wall
Spool_Wall_Thickness = 3.5;//[1:0.1:7]


Filament_Hole_Tolerance = 0.4; //[0:0.1:3]
...
Spool_Wall_Thickness_Left = Spool_Wall_Thickness;   //[1:0.1:7]
//Thickness of right spool wall
Spool_Wall_Thickness_Right = Spool_Wall_Thickness;  //[1:0.1:7]
...
Filament_Channel = "internal"; // [internal:Inside the Label,under:Underneath the Label,none:None]
Filament_Hole_Diameter = 1.8 + Filament_Hole_Tolerance;
