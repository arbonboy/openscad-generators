...
// Irregular separator positions are a CSV string defined in terms of grid units from the left end
irregular_separator_list = "0.6,1.2,1.9,2.6,3.6,4.6";

module end_of_customizer_opts() {}
// Separator positions are defined in terms of grid units from the left end
//separator_positions = [ 0.25, 0.5, 1.8 ];
//separator_positions = irregular_separator_list.split(",");
separator_positions = [0.7,1.4,2.2,3,4,5];
